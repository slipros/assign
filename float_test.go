...
func TestFloat_Successfully(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "positive float to bool - positive",
			setupField: func() (reflect.Value, any, any) {
				s := &TestStruct{}
		...
		{
			name: "negative float to bool - positive",
			setupField: func() (reflect.Value, any, any) {
				s := &TestStruct{}
				field := reflect.ValueOf(s).Elem().FieldByName("Bool")
				return field, -42.5, true
			},
		},
		{
		...
		{
			name: "positive float to nil pointer to bool",
			setupField: func() (reflect.Value, any, any) {
				s := &TestStruct{}
		...
		{
			name: "negative float to nil pointer to bool",
			setupField: func() (reflect.Value, any, any) {
				s := &TestStruct{}
				field := reflect.ValueOf(s).Elem().FieldByName("NilPtrBool")
				return field, -42.5, true // Should initialize and set true
...
func TestFloat_Failure(t *testing.T) {
...
// Benchmark for Float performance
func BenchmarkFloat(b *testing.B) {
	...
	b.Run("FloatToNumeric", func(b *testing.B) {
		...
		runBenchmark("Float-Value-Int", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Int")
		}, func(field reflect.Value) {
			_ = Float(field, smallFloat)
		})

		// Float to float conversions
		runBenchmark("Float-Value-Float32", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Float32")
		}, func(field reflect.Value) {
			_ = Float(field, smallFloat)
		})

		runBenchmark("Float-Value-Float64", func() reflect.Value {
		...
		runBenchmark("LargeFloat-Value-Float64", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Float64")
		}, func(field reflect.Value) {
			_ = Float(field, largeFloat)
		})

		runBenchmark("NegativeFloat-Value-Int", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Int")
		}, func(field reflect.Value) {
			_ = Float(field, negativeFloat)
		})
	})
	...
	b.Run("FloatToOtherTypes", func(b *testing.B) {
		...
		runBenchmark("Float-Value-String", func() reflect.Value {
		...
		runBenchmark("LargeFloat-Value-String", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("String")
		}, func(field reflect.Value) {
			_ = Float(field, largeFloat)
		})
		...
		runBenchmark("PositiveFloat-Value-Bool", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Bool")
		}, func(field reflect.Value) {
			_ = Float(field, smallFloat)
		})

		runBenchmark("NegativeFloat-Value-Bool", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Bool")
		}, func(field reflect.Value) {
			_ = Float(field, negativeFloat)
		})

		runBenchmark("ZeroFloat-Value-Bool", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Bool")
		}, func(field reflect.Value) {
			_ = Float(field, 0.0)
		})
	...
	b.Run("FloatToPointer", func(b *testing.B) {
		...
		runBenchmark("Float-Value-InitializedPtrInt", func() reflect.Value {
		...
		runBenchmark("Float-Value-InitializedPtrString", func() reflect.Value {
		...
		runBenchmark("Float-Value-InitializedPtrFloat", func() reflect.Value {
		...
		runBenchmark("Float-Value-NilPtrInt", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("NilPtrInt")
		}, func(field reflect.Value) {
			_ = Float(field, smallFloat)
		})

		runBenchmark("Float-Value-NilPtrFloat", func() reflect.Value {
	...
	// Compare Float with direct reflect operations
	b.Run("CompareWithNativeReflect", func(b *testing.B) {
		// Float to Float64 comparison
		b.Run("Float-Value-Float64", func(b *testing.B) {
			// Our implementation
		...
		b.Run("Float-Value-String", func(b *testing.B) {
			// Our implementation
			b.Run("Float", func(b *testing.B) {
				s := &TestStruct{}
				field := reflect.ValueOf(s).Elem().FieldByName("String")
		...
		b.Run("Float-Value-Int", func(b *testing.B) {
			// Our implementation
			b.Run("Float", func(b *testing.B) {
				s := &TestStruct{}
				field := reflect.ValueOf(s).Elem().FieldByName("Int")
		...
		b.Run("Float-Value-Bool", func(b *testing.B) {
			// Our implementation
			b.Run("Float", func(b *testing.B) {
				s := &TestStruct{}
				field := reflect.ValueOf(s).Elem().FieldByName("Bool")
	...
	b.Run("SpecialFloatValues", func(b *testing.B) {
		...
		runBenchmark("NaN-Value-String", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("String")
		}, func(field reflect.Value) {
			_ = Float(field, nanValue)
		})

		runBenchmark("NaN-Value-Float64", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Float64")
		}, func(field reflect.Value) {
			_ = Float(field, nanValue)
		})
		...
		runBenchmark("PosInf-Value-String", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("String")
		}, func(field reflect.Value) {
			_ = Float(field, posInfValue)
		})

		runBenchmark("PosInf-Value-Float64", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Float64")
		}, func(field reflect.Value) {
			_ = Float(field, posInfValue)
		})
		...
		// -Infinity to different types
		runBenchmark("NegInf-Value-String", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("String")
		}, func(field reflect.Value) {
			_ = Float(field, negInfValue)
		})

		runBenchmark("NegInf-Value-Float64", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Float64")
		}, func(field reflect.Value) {
			_ = Float(field, negInfValue)
		})
		...
		runBenchmark("TinyFloat-Value-Int", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Int")
		}, func(field reflect.Value) {
			_ = Float(field, tinyValue)
		})
	})
}
