...
func TestInteger_Successfully(t *testing.T) {
...
func TestInteger_Failure(t *testing.T) {
	// Define a struct with fields of various types to test setting values
	type TestStruct struct {
		Int8  int8
		Int16 int16
...
func BenchmarkInteger(b *testing.B) {
	...
	b.Run("SignedInt", func(b *testing.B) {
		...
		runBenchmark("Small-Int-Value-Int", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Int")
		}, func(field reflect.Value) {
			_ = Integer(field, smallInt)
		})

		runBenchmark("Small-Int-Value-Int8", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Int8")
		}, func(field reflect.Value) {
			_ = Integer(field, smallInt)
		})

		runBenchmark("Small-Int-Value-Int16", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Int16")
		}, func(field reflect.Value) {
			_ = Integer(field, smallInt)
		})

		runBenchmark("Small-Int-Value-Int32", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Int32")
		}, func(field reflect.Value) {
			_ = Integer(field, smallInt)
		})

		runBenchmark("Small-Int-Value-Int64", func() reflect.Value {
		...
		runBenchmark("Medium-Int-Value-Int", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Int")
		}, func(field reflect.Value) {
			_ = Integer(field, mediumInt)
		})

		// Large value int to int
		runBenchmark("Large-Int-Value-Int", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Int")
		}, func(field reflect.Value) {
			_ = Integer(field, largeInt)
		})
	})
	...
	b.Run("UnsignedInt", func(b *testing.B) {
		...
		runBenchmark("Small-Uint-Value-Uint", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Uint")
		}, func(field reflect.Value) {
			_ = Integer(field, smallUint)
		})

		runBenchmark("Small-Uint-Value-Uint8", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Uint8")
		}, func(field reflect.Value) {
			_ = Integer(field, smallUint)
		})

		runBenchmark("Small-Uint-Value-Uint16", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Uint16")
		}, func(field reflect.Value) {
			_ = Integer(field, smallUint)
		})

		runBenchmark("Small-Uint-Value-Uint32", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Uint32")
		}, func(field reflect.Value) {
			_ = Integer(field, smallUint)
		})

		runBenchmark("Small-Uint-Value-Uint64", func() reflect.Value {
		...
		runBenchmark("Large-Uint-Value-Uint", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Uint")
		}, func(field reflect.Value) {
			_ = Integer(field, largeUint)
		})
	})

	// Benchmark integer-to-string conversion (commonly used in web requests)
	b.Run("StringConversions", func(b *testing.B) {
		runBenchmark("Small-Int-Value-String", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("String")
		}, func(field reflect.Value) {
			_ = Integer(field, smallInt)
		})

		runBenchmark("Medium-Int-Value-String", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("String")
		}, func(field reflect.Value) {
			_ = Integer(field, mediumInt)
		})

		runBenchmark("Large-Int-Value-String", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("String")
		}, func(field reflect.Value) {
			_ = Integer(field, largeInt)
		})

		runBenchmark("Small-Uint-Value-String", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("String")
		}, func(field reflect.Value) {
			_ = Integer(field, smallUint)
		})

		runBenchmark("Large-Uint-Value-String", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("String")
		}, func(field reflect.Value) {
			_ = Integer(field, largeUint)
		})
	...
	b.Run("FloatConversions", func(b *testing.B) {
		runBenchmark("Int-Value-Float32", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Float32")
		}, func(field reflect.Value) {
			_ = Integer(field, smallInt)
		})

		runBenchmark("Int-Value-Float64", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Float64")
		}, func(field reflect.Value) {
			_ = Integer(field, smallInt)
		})

		runBenchmark("Large-Int-Value-Float64", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Float64")
		}, func(field reflect.Value) {
			_ = Integer(field, largeInt)
		})

		runBenchmark("Uint-Value-Float64", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Float64")
		}, func(field reflect.Value) {
			_ = Integer(field, smallUint)
		})
	...
	b.Run("BoolConversions", func(b *testing.B) {
		...
		runBenchmark("Zero-Int-Value-Bool", func() reflect.Value {
		...
		runBenchmark("Positive-Int-Value-Bool", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Bool")
		}, func(field reflect.Value) {
			_ = Integer(field, smallInt)
		})
		...
		runBenchmark("Negative-Int-Value-Bool", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Bool")
		}, func(field reflect.Value) {
			_ = Integer(field, -1)
		})
		...
		runBenchmark("Zero-Uint-Value-Bool", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Bool")
		}, func(field reflect.Value) {
			_ = Integer(field, uint(0))
		})

		// Test with positive unsigned value
		runBenchmark("Positive-Uint-Value-Bool", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Bool")
		}, func(field reflect.Value) {
			_ = Integer(field, smallUint)
		})
	...
	b.Run("OtherConversions", func(b *testing.B) {
		runBenchmark("Int-Value-Complex", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Complex")
		}, func(field reflect.Value) {
			_ = Integer(field, smallInt)
		})

		runBenchmark("Int-Value-Interface", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Interface")
		}, func(field reflect.Value) {
			_ = Integer(field, smallInt)
		})

		runBenchmark("Uint-Value-Interface", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Interface")
		}, func(field reflect.Value) {
			_ = Integer(field, smallUint)
		})
	...
	b.Run("PointerHandling", func(b *testing.B) {
		...
		runBenchmark("Int-Value-InitializedPtrInt", func() reflect.Value {
		...
		runBenchmark("Int-Value-InitializedPtrString", func() reflect.Value {
		...
		runBenchmark("Int-Value-NilPtrInt", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("NilPtrInt")
		}, func(field reflect.Value) {
			_ = Integer(field, smallInt)
		})

		runBenchmark("Int-Value-NilPtrBool", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("NilPtrBool")
		}, func(field reflect.Value) {
			_ = Integer(field, smallInt)
		})

		runBenchmark("Int-Value-NilPtrFloat", func() reflect.Value {
	...
	// Compare Integer with direct reflect operations using standard type conversions
	b.Run("CompareWithReflect", func(b *testing.B) {
		// First group: Int to Int conversion
		b.Run("Int-Value-Int", func(b *testing.B) {
			// Our implementation
		...
		b.Run("Int-Value-String", func(b *testing.B) {
			// Our implementation
			b.Run("Integer", func(b *testing.B) {
				s := &TestStruct{}
				field := reflect.ValueOf(s).Elem().FieldByName("String")
		...
		b.Run("Int-Value-Float64", func(b *testing.B) {
			// Our implementation
			b.Run("Integer", func(b *testing.B) {
				s := &TestStruct{}
				field := reflect.ValueOf(s).Elem().FieldByName("Float64")
		...
		b.Run("Int-Value-Bool", func(b *testing.B) {
			// Our implementation
			b.Run("Integer", func(b *testing.B) {
				s := &TestStruct{}
				field := reflect.ValueOf(s).Elem().FieldByName("Bool")
		...
		b.Run("Int-Value-Interface", func(b *testing.B) {
			// Our implementation
			b.Run("Integer", func(b *testing.B) {
				s := &TestStruct{}
				field := reflect.ValueOf(s).Elem().FieldByName("Interface")
		...
		b.Run("Int-Value-NilPtr", func(b *testing.B) {
			// Our implementation
			b.Run("Integer", func(b *testing.B) {
				s := &TestStruct{}
				field := reflect.ValueOf(s).Elem().FieldByName("NilPtrInt")
	...
	b.Run("EdgeCases", func(b *testing.B) {
		...
		runBenchmark("MaxInt8-Value-Int16", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Int16")
		}, func(field reflect.Value) {
			_ = Integer(field, int8(math.MaxInt8))
		})

		runBenchmark("MaxInt16-Value-Int32", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Int32")
		}, func(field reflect.Value) {
			_ = Integer(field, int16(math.MaxInt16))
		})

		runBenchmark("MaxUint8-Value-Uint16", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Uint16")
		}, func(field reflect.Value) {
			_ = Integer(field, uint8(math.MaxUint8))
		})

		runBenchmark("MaxUint16-Value-Uint32", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Uint32")
		}, func(field reflect.Value) {
			_ = Integer(field, uint16(math.MaxUint16))
		})

		// Min values
		runBenchmark("MinInt8-Value-Int16", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Int16")
		}, func(field reflect.Value) {
			_ = Integer(field, int8(math.MinInt8))
		})

		runBenchmark("MinInt16-Value-Int32", func() reflect.Value {
			return reflect.ValueOf(&TestStruct{}).Elem().FieldByName("Int32")
		}, func(field reflect.Value) {
			_ = Integer(field, int16(math.MinInt16))
		})
	})
}
